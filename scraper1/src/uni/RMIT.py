    ...
    def ScrapeForData(self, isRaw, depth, keywords):
        ...
        for i in range(len(keywords)):
            for y in range(depth):
                ...
                url = 'https://openresearch.surrey.ac.uk/esplorows/rest/research/simpleSearch/assets?institution=61RMIT_INST&q=sub%2Ccontains%2C' + keywords[i] + '%2CAND&scope=Research&tab=Research&offset=' + str(responsesStartPos) + '&limit=' + str(responsesStartPos + responsesPerPage) + '&sort=date_d&lang=en&enableAsteriskSearch=false'
